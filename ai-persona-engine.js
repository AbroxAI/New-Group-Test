// ====================== AI PERSONA ENGINE v7.3 (Full – Forced AI-to-AI Replies with Preview Bar) ======================
// 450+ personas · Realistic avatars · Archetypes · Forced AI-to-AI replies · Always uses reply preview bar
...
(function(){
  ...
  // Helper to get the last AI message (excluding a given personaId)
  ...
  // Override startSimulation to seed the chat with initial AI messages
  ...
  log(`🤖 AI Persona Engine v7.3 loaded with ${personas.length} personas. Forced AI-to-AI replies with preview bar. Chat seeded with initial AI messages.`);
})();
