// ====================== AI PERSONA ENGINE v3.2 ======================
// Expanded phrase banks (2000+ templates) · Colored names · Default avatars
// Typos · Varied name formats · Reply chains · Testimonials · Join stickers
// ====================================================================
(function(){
  "use strict";
  ...
  const globalPhraseBank = {
    question: [
      ...
      "should I use fixed or percentage stake?", "what's the best expiry time?",
      "do you trade binary or digital?", "how to combine signals with my own analysis?",
      "what's the success rate of your premium signals?", "can I trust the AI predictions?",
      "do you provide signals for indices?", "how do I deal with slippage?",
      "is there a community where I can ask questions?", "how often do you update the signals?",
      "what's the refund policy?", "do you have a trial period?"
    ],
    result: [
  ...
  // ---------- PERSONA GENERATION (450+ varied names) ----------
  const firstNames = {
  ...
  log(`🤖 AI Persona Engine v3.2 loaded with ${personas.length} personas and expanded phrase banks.`);
})();
